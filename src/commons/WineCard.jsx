...
export default function WineCard({ vino }) {
  ...
  const handleClickFav = (e) => {
    ...
    const {marca, descripcion,bodega, nombre, tipo, precio, valoracion, stock,images} = vino;
    //hacemos post con los datos necesarios por el req.body
    axios.post("api/products/add", {name,email,marca, descripcion,bodega, nombre, tipo, precio, valoracion, stock,images:images[0].url})
    .then((res) => res.data)
    .then((producto)=>{
